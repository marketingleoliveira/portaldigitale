        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto animate-fade-in">
            <h1 className="text-4xl lg:text-6xl font-bold mb-6">
              Portal Comercial
              <span className="text-primary block mt-2">Digitale Têxtil</span>
            </h1>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Acesse catálogos, fichas técnicas e informações comerciais exclusivas para sua equipe de vendas.
            </p>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-card rounded-xl shadow-sm animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="text-center p-6 bg-card rounded-xl shadow-sm animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="text-center p-6 bg-card rounded-xl shadow-sm animate-fade-in" style={{ animationDelay: '0.3s' }}>
